export const projectsAll = [
    {
      title: "HiveSocial",
      description: "A small Social Media Web App functional UI developed using React JS, TypeScript, and Ant Design libraries. Features include user authentication, post creation/viewing, liking and bookmarking posts, commenting, and profile updates.",
    ...
    {
      title: "MiniMail",
      description: "A simple email client built with React that allows users to view, filter, and manage emails. The application fetches email data from a mock API and provides a user-friendly interface for navigating through emails.",
    ...
    },
    {
      ...
      links: {
        ...
        hosted: "https://www.figma.com/community/plugin/1295738909015351601/node-comparator-plugin-shivank"
      },
      tech: ["Figma Plugin", "JavaScript", "Node.js"]
    },
    {
      title: "Http-server",
      description: "A custom JavaScript HTTP server that handles port binding, GET requests (200 and 404 responses), concurrent connections, file fetching, and posting data.",
      image: "/Assets/Projects/web-server.png",  // Adjusted path
      start: "",
      end: "",
      links: {
        github: "https://github.com/shivankkunwar/codecrafters-http-server-javascript",
        hosted: "https://github.com/shivankkunwar/codecrafters-http-server-javascript"
      },
      tech: ["JavaScript"]
    },
    {
      title: "Faced",
      description: "A full-stack Face Detection Web Application using React, TypeScript, Node.js, PostgreSQL, and JavaScript, integrated with the Face API JavaScript API for face detection.",
    ...
    {
      title: "Searches",
      description: "A React app featuring a search bar and dynamic cards, swiftly filtering and displaying content as you type.",
    ...
    },
    {
      ...
      description: "A WhatsApp frontend clone using React and Redux. Features include message addition, clickable elements, scrollable chats, and displaying the last message on the sidebar.",
    ...
    {
      title: "TinyProjects",
      description: "A curated collection of bite-sized React applications and components. Includes sliders, accordions, search bars, counters, and a blog list.",
    ...
    {
      title: "Weather APP",
      description: "Enter any city name to get real-time weather information using JavaScript, HTML, and CSS.",
    ...
    {
      title: "Text Editor",
      description: "A text editor built with JavaScript, HTML, and CSS. Allows formatting like italic, bold, and text alignment.",
    ...
    },
    {
      ...
      description: "A budget app that lets you track income and expenses, add descriptions, and watch your total income and expenses being calculated.",
...
export const projectWall = [
    {
      ...
      {
        title: "Rereload",
        description: "A lightweight Node.js package that watches a specified folder for file changes and automatically restarts a server script when changes are detected.",
